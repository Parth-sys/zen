...
async function postData() {
    try {
        ...
        if (flag == "create") {
            var postinfo = await fetch("https://60ebd304e9647b0017cdde45.mockapi.io/users1", {
                method: "POST",
                headers: {
        ...
        if(flag == "edit"){
            var postinfo = await fetch("https://60ebd304e9647b0017cdde45.mockapi.io/users1" + selectedId, {
                method: "PUT",
                headers: {
                    "Content-type": "application/json"
                },
...
async function getData() {
    var data = await fetch("https://60ebd304e9647b0017cdde45.mockapi.io/users1");
...
async function deleteData(id) {
    var deleteData = await fetch("https://60ebd304e9647b0017cdde45.mockapi.io/users1" + id, {
        method: "DELETE"
    })
...
async function editData(id) {
    ...
    var rowData = await fetch("https://60ebd304e9647b0017cdde45.mockapi.io/users1" + id);
